...
# Seed deterministic Factory data in production so smoke tests can validate
...
DB_NAME="planning-primary"

SEEDED_RUN_ID="factory-smoke-run-production"
SEEDED_BUILD_SPEC_ID="factory-smoke-build-spec-production"

if [ "$ENVIRONMENT" != "production" ]; then
  echo "This seeding script is restricted to production."
...
INSERT INTO planning_runs (
  ...
  '${SEEDED_RUN_ID}',
  'Factory smoke seeded run (production)',
  'Factory smoke seeded run (production)',
  'completed',
