-- Migration: Allow 'fallback' status in build_specs (D1-compatible version)
-- Required for Architecture Advisor degraded-mode outputs.
-- D1 automatically wraps migrations in transactions, so no explicit BEGIN/COMMIT needed.
